...
if __name__ == "__main__":
    # parser = PDDLActionParser("../domains/robotics_twoarms.pddl", "../domains/robotics_twoarms_12cans_prob.pddl", "test_plan.txt")
    # parser = PDDLActionParser("../domains/dinnerTime_dom.pddl", "../domains/dinnerTime_prob.pddl", "test_plan.txt")
    #parser = PDDLActionParser("../domains/dinnerTime_twoarms_costs_dom.pddl", "../domains/dinnerTime_twoarms_costs_prob.pddl", "test_plan.txt")
    parser = PDDLActionParser("../../domains/towers_of_hanoi_dom2.pddl", "../../domains/towers_of_hanoi_prob2.pddl", "test_plan.txt")
    #parser = PDDLActionParser("/home/ronuchit/Documents/OpenRaving/planners/FD/benchmarks/barman-sat11-strips/domain.pddl", "/home/ronuchit/Documents/OpenRaving/planners/FD/benchmarks/barman-sat11-strips/pfile06-021.pddl", "test_planfd.txt")
    # parser = PDDLActionParser("/home/ronuchit/Documents/OpenRaving/planners/FD/benchmarks/openstacks-sat11-strips/p11-domain.pddl", "/home/ronuchit/Documents/OpenRaving/planners/FD/benchmarks/openstacks-sat11-strips/p11.pddl", "test_planfd.txt")
    a = parser.execute()
